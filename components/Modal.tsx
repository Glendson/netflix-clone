...
import { ThumbUpIcon, XIcon, PlusIcon, VolumeOffIcon, VolumeUpIcon, CheckIcon } from '@heroicons/react/outline'
...
function Modal() {
    ...
    useEffect(() => {
        if (user) {
            return onSnapshot(collection(db, 'customers', user.uid, 'myList'),
